 ...
 * the allocation request size with the initial value of 'out_size'. This
 ...
 * with the inital value of 'out_size'. This allows teh caller to guarantee
 * an additional padding at the end of the string.
 *
 * The number of characters written is recoreded in the output parameter
 * 'out_size'. The caller is epected to call unicode_utf32_string_free to
